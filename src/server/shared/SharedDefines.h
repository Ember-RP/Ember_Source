...
enum Races
{
    ...
    //RACE_FEL_ORC            = 12,
    // Because the client is hardcoded to a max of 21 races, we must replace an existing definition.
    RACE_WORGEN             = 12, // TITLE Worgen
    //RACE_NAGA               = 13,
    //RACE_BROKEN             = 14,
    RACE_HIGHELF            = 14, // TITLE High Elf
    //RACE_SKELETON           = 15,
    //RACE_VRYKUL             = 16,
    //RACE_TUSKARR            = 17,
...
#define RACEMASK_ALL_PLAYABLE \
    ((1<<(RACE_HUMAN-1))   |(1<<(RACE_ORC-1))          |(1<<(RACE_DWARF-1))   | \
     ...
     (1<<(RACE_HIGHELF-1)) |(1<<(RACE_FOREST_TROLL-1)))
...
enum SkillType
{
    ...
    SKILL_WEAVER                   = 700, // CUSTOM EMBER
    SKILL_COOKING_WAKE             = 701, // CUSTOM EMBER
    SKILL_LEATHERWORKING_WAKE      = 702, // CUSTOM EMBER
    SKILL_BLACKSMITHING_WAKE       = 703, // CUSTOM EMBER
    SKILL_CARPENTRY_WAKE           = 704, // CUSTOM EMBER
    SKILL_TAILORING_WAKE           = 705, // CUSTOM EMBER
    SKILL_ALCHEMY_WAKE             = 706, // CUSTOM EMBER
    SKILL_INSCRIPTION_WAKE         = 707, // CUSTOM EMBER
    SKILL_FIRST_AID_WAKE           = 708, // CUSTOM EMBER
    SKILL_MYSTIC_WAKE              = 709, // CUSTOM EMBER
