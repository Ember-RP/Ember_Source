...
ElunaRegister<Player> PlayerMethods[] =
{
	...
	// Custom Ember Player
    { "GetObjectFromPlayerMapByDbGuid", &LuaPlayer::GetObjectFromPlayerMapByDbGuid },
	{ "CreateCorpse", &LuaPlayer::CreateCorpse },
    { "GetSkin", &LuaPlayer::GetSkin }, // CUSTOM
    { "SetSkin", &LuaPlayer::SetSkin }, // CUSTOM
    { "GetHair", &LuaPlayer::GetHair }, // CUSTOM
    { "SetHair", &LuaPlayer::SetHair }, // CUSTOM
    { "GetHairColor", &LuaPlayer::GetHairColor }, // CUSTOM
    { "SetHairColor", &LuaPlayer::SetHairColor }, // CUSTOM
    { "GetFacial", &LuaPlayer::GetFacial }, // CUSTOM
    { "SetFacial", &LuaPlayer::SetFacial }, // CUSTOM
    { "GetFace", &LuaPlayer::GetFace }, // CUSTOM
    { "SetFace", &LuaPlayer::SetFace }, // CUSTOM
    // Getters
...
{
	// Custom Ember GameObject
	{ "SetTurn", &LuaGameObject::SetTurn },
    { "TeleportObject", &LuaGameObject::TeleportObject },
    { "SetGameObjectScale", &LuaGameObject::SetGameObjectScale },
