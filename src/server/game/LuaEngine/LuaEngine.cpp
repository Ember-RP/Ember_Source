...
void Eluna::_ReloadEluna()
{
	...
	// EMBER - Didrik added this to avoid spamming players when we (sadly?) have to reload Eluna on the production server.
    sWorld->SendGMText(LANG_GM_BROADCAST, "Reloading Eluna...");
