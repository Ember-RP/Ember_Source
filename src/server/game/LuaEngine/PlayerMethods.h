...
namespace LuaPlayer
{
	...
	// CUSTOM EMBER PLAYER FUNCTIONS
	
	/**
     * Returns a [WorldObject] by its DB GUID from the players map.
     *
     * @param uint32 guid
     */
    int GetObjectFromPlayerMapByDbGuid(lua_State* L, Player* player)
    {
        uint32 lowguid = Eluna::CHECKVAL<uint32>(L, 2);

        Eluna::Push(L, ChatHandler(player->GetSession()).GetObjectFromPlayerMapByDbGuid(lowguid));
        return 1;
    }
	...
	/**
     * Returns the [Player]s skin ID
     *
     * @return uint8 skinId
     */
    int GetSkin(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->GetSkinId());
        return 1;
    }

    /**
     * Sets SkinID of [Player]
     *
     * @param uint8 skinId
     */
    int SetSkin(lua_State* L, Player* player)
    {
        uint8 skinid = Eluna::CHECKVAL<uint8>(L, 2);
     ...
     *
     * @return uint8 hairStyleId
     */
    int GetHair(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->GetHairStyleId());
        return 1;
    }

    /**
     * Sets HairStyleId of [Player]
     *
     * @param uint8 hairStyleId
     */
    int SetHair(lua_State* L, Player* player)
    {
        uint8 hairstyleid = Eluna::CHECKVAL<uint8>(L, 2);

        player->SetHairStyleId(hairstyleid);
        return 0;
    }

    /**
     * Returns the [Player]s hair color ID
     *
     * @return uint8 hairColorId
     */
    int GetHairColor(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->GetHairColorId());
        return 1;
    }

    /**
     * Sets hairColorID of [Player]
     *
     * @param uint8 hairColorId
     */
    int SetHairColor(lua_State* L, Player* player)
    {
        uint8 haircolorid = Eluna::CHECKVAL<uint8>(L, 2);

        player->SetHairColorId(haircolorid);
        return 0;
    }

    /**
     * Returns the [Player]s facial style
     *
     * @return uint8 facialStyle
     */
    int GetFacial(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->GetFacialStyle());
        return 1;
    }

    /**
     * Sets facial style of [Player]
     *
     * @param uint8 faceStyle
     */
    int SetFacial(lua_State* L, Player* player)
    {
        uint8 facialstyle = Eluna::CHECKVAL<uint8>(L, 2);

        player->SetFacialStyle(facialstyle);
        return 0;
    }

    /**
     * Returns the [Player]s face ID
     *
     * @return uint8 faceId
     */
    int GetFace(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->GetFaceId());
        return 1;
    }

    /**
     * Sets FaceID of [Player]
     *
     * @param uint8 faceId
     */
    int SetFace(lua_State* L, Player* player)
    {
        uint8 faceid = Eluna::CHECKVAL<uint8>(L, 2);
	...
	// END CUSTOM EMBER PLAYER FUNCTIONS
};
#endif
