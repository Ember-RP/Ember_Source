...
bool fillArchiveNameVector(std::vector<std::string>& pArchiveNames)
{
    ...
    // Add custom Ember patches
    printf("Adding Ember patches C,I,M,O,T,X last to override Blizzard map.dbc and stuff.\n");
    pArchiveNames.push_back(input_path + std::string("Patch-C.MPQ")); // CUSTOM EMBER
    pArchiveNames.push_back(input_path + std::string("Patch-I.MPQ")); // CUSTOM EMBER
    pArchiveNames.push_back(input_path + std::string("Patch-M.MPQ")); // CUSTOM EMBER
    pArchiveNames.push_back(input_path + std::string("Patch-O.MPQ")); // CUSTOM EMBER
    pArchiveNames.push_back(input_path + std::string("Patch-T.MPQ")); // CUSTOM EMBER
    pArchiveNames.push_back(input_path + std::string("Patch-X.MPQ")); // CUSTOM EMBER
